 ...
 */
@Plugin(name = IonicRollingFileAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class IonicRollingFileAppender extends IonicAbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "IonicRollingFile";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<IonicRollingFileAppender> {
        ...
        @Override
        public IonicRollingFileAppender build() {
            ...
            if (getName() == null) {
                LOGGER.error("IonicRollingFileAppender '{}': No name provided.", getName());
                return null;
            }

            if (!isBufferedIo && bufferSize > 0) {
                LOGGER.warn("IonicRollingFileAppender '{}': The bufferSize is set to {} but bufferedIO is not true", getName(), bufferSize);
            }

            if (filePattern == null) {
                LOGGER.error("IonicRollingFileAppender '{}': No file name pattern provided.", getName());
                return null;
            }

            if (policy == null) {
                LOGGER.error("IonicRollingFileAppender '{}': No TriggeringPolicy provided.", getName());
                return null;
            }
            ...
            if (strategy == null) {
                ...
                LOGGER.error("IonicRollingFileAppender '{}': When no file name is provided a DirectFilenameRolloverStrategy must be configured");
                return null;
            }
            ...
            return new IonicRollingFileAppender(getName(), layout, getFilter(), manager, fileName, filePattern, ionicProfile,
    ...
    private IonicRollingFileAppender(final String name, final Layout<? extends Serializable> layout, final Filter filter,
                                     final RollingFileManager manager, final String fileName, final String filePattern,
                                     final String ionicProfile,
    ...
    /**
     * Creates an IonicRollingFileAppender.
     ...
     * @return An IonicRollingFileAppender.
     * @deprecated Use {@link #newBuilder()}.
     */
    @Deprecated
    public static <B extends Builder<B>> IonicRollingFileAppender createAppender(
            // @formatter:off
        ...
        // @formatter:off
        return IonicRollingFileAppender.<B>newBuilder()
